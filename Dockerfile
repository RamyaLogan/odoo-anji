# -------- Stage 1: Build Stage --------
    ...
    RUN apt-get update && apt-get install -y --no-install-recommends \
        ...
        libsasl2-2 libssl3 fontconfig libfreetype6 libjpeg62-turbo libx11-6 libxext6 libxrender1 wget xz-utils \
        && wget https://github.com/wkhtmltopdf/packaging/releases/download/0.12.6.1-3/wkhtmltox_0.12.6.1-3.bionic_amd64.deb \
        && dpkg -i wkhtmltox_0.12.6.1-3.bionic_amd64.deb || apt-get -f install -y \
